<html>
    <head>
        ...
        <!-- summernote -->
        <link rel="stylesheet" href="<?= base_url ?>recursos/plugins/summernote/summernote-bs4.css">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="<?= base_url ?>recursos/dist/img/user2-160x160.jpg" class="user-image img-circle elevation-2" alt="User Image">
                        <span class="d-none d-md-inline">Carol</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- User image -->
                        <li class="user-header bg-primary">
                            <img src="recursos/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
